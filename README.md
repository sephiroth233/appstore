...
```shell
git clone -b localApps https://github.com/sephiroth233/appstore /opt/1panel/resource/apps/local/appstore-localApps
...
`1Panel`计划任务类型`Shell 脚本`的计划任务框里，添加并执行以下命令，或者终端运行以下命令，
```shell
wget -P /opt/1panel/resource/apps/local https://github.com/sephiroth233/appstore/archive/refs/heads/localApps.zip
